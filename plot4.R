...
plot(power_data$long_date, power_data$Voltage, xaxt = "n", type = "l", 
...
r <- as.POSIXct(round(range(power_data$long_date), "days"))
axis.POSIXct(1, at=seq(r[1], r[2], by="days"), format="%d", labels = c("Thu", "Fri", "Sat"))
legend("topright", legend = "Sub_metering_3", bty = "n", lty = 1, col = "blue")

plot(power_data$long_date, power_data$Global_reactive_power, xaxt = "n", type = "l", 
     xlab = "datetime", ylab = "Voltage")
r <- as.POSIXct(round(range(power_data$long_date), "days"))
axis.POSIXct(1, at=seq(r[1], r[2], by="days"), format="%d", labels = c("Thu", "Fri", "Sat"))
